...
public:
    ...
    void setupUi(QMainWindow *w_main)
    {
        ...
        language_en = new QAction(w_main);
        language_en->setObjectName(QStringLiteral("language_en"));
        language_en->setCheckable(true);
        language_en->setChecked(false);
        language_fr = new QAction(w_main);
        language_fr->setObjectName(QStringLiteral("language_fr"));
        language_fr->setCheckable(true);
        language_fr->setChecked(false);
        language_si = new QAction(w_main);
        language_si->setObjectName(QStringLiteral("language_si"));
        language_si->setCheckable(true);
        language_hu = new QAction(w_main);
        language_hu->setObjectName(QStringLiteral("language_hu"));
        language_hu->setCheckable(true);
        language_fi = new QAction(w_main);
        language_fi->setObjectName(QStringLiteral("language_fi"));
        language_fi->setCheckable(true);
        language_pl = new QAction(w_main);
        language_pl->setObjectName(QStringLiteral("language_pl"));
        language_pl->setCheckable(true);
        language_it = new QAction(w_main);
        language_it->setObjectName(QStringLiteral("language_it"));
        language_it->setCheckable(true);
        language_es = new QAction(w_main);
        language_es->setObjectName(QStringLiteral("language_es"));
        language_es->setCheckable(true);
        language_de = new QAction(w_main);
        language_de->setObjectName(QStringLiteral("language_de"));
        language_de->setCheckable(true);
        language_ru = new QAction(w_main);
        language_ru->setObjectName(QStringLiteral("language_ru"));
        language_ru->setCheckable(true);
        ...
        menuLanguage->addAction(language_en);
        menuLanguage->addAction(language_fi);
        menuLanguage->addAction(language_fr);
        menuLanguage->addAction(language_de);
        menuLanguage->addAction(language_hu);
        menuLanguage->addAction(language_it);
        menuLanguage->addAction(language_pl);
        menuLanguage->addAction(language_ru);
        menuLanguage->addAction(language_si);
        menuLanguage->addAction(language_es);
    ...
    void retranslateUi(QMainWindow *w_main)
    {
        ...
        language_en->setText(QApplication::translate("w_main", "English", 0));
        language_fr->setText(QApplication::translate("w_main", "French", 0));
        language_si->setText(QApplication::translate("w_main", "Sinhala", 0));
        language_hu->setText(QApplication::translate("w_main", "Hungarian", 0));
        language_fi->setText(QApplication::translate("w_main", "Finnish", 0));
        language_pl->setText(QApplication::translate("w_main", "Polish", 0));
        language_it->setText(QApplication::translate("w_main", "Italian", 0));
        language_es->setText(QApplication::translate("w_main", "Spanish", 0));
        language_de->setText(QApplication::translate("w_main", "German", 0));
        language_ru->setText(QApplication::translate("w_main", "Russian", 0));
